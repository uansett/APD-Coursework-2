...
public class Poly {
    ...
    public Poly add(Poly q) throws NullPointerException{
        ...
        if(q.terms.length > terms.length){
            largest = q;smallest = this;
        }else{
            largest = this; smallest = q;
        }
    ...
    public boolean equals(Object o){
        ...
        if(this.deg == a.deg && a.terms.length == this.terms.length) {
            for(int i=0;i<terms.length;i++){
                if(!this.terms[0].equals(a.terms[0])) return false;
            }
            return true;
        }
        return false;
    ...
    class Pair {
        ...
        public boolean equals(Object o){
            ...
            Pair a = (Pair) o;
            if(a.coeff == this.coeff && a.exp == this.exp) return true;
            return false;
        }
    }
